...
Automatización: Es la parte "inteligente" detrás de escenas. Significa que usas herramientas para que las tareas repetitivas se hagan solas (por ejemplo: que al subir tu código, se revise automáticamente si hay errores o se publique solo en internet).).*

* **Tecnologías usadas:** HTML, CSS, JavaScript.
* **Lo que aprendí:** Implementación de manipulación del DOM, manejo de eventos y diseño responsivo.

**Funcionalidad clave:** Implementación de un CRUD completo y manejo de sesiones seguras.
 
**💻Contacto:** ceyli.maricel.romero@clases.edu.sv
